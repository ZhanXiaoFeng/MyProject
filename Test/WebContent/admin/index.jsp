...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/admin/assets/css/ace-skins.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/admin/css/style.css" />
<script
	src="${pageContext.request.contextPath}/admin/assets/js/ace-extra.min.js"></script>
<script
...
<script
	src="${pageContext.request.contextPath}/admin/assets/js/ace-elements.min.js"></script>
<script
	src="${pageContext.request.contextPath}/admin/assets/js/ace.min.js"></script>
<script
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <img
						...
						width="350px" height="100px" style="margin-top: -10px;">
				</small>
				</a>
				<!-- /.brand -->
			</div>
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="javascript:void(0)"
								name="${pageContext.request.contextPath}/selectById.do?id=${admin2.id}"
								title="个人信息" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
							<li><a href="javascript:void(0"
								name="${pageContext.request.contextPath}/admin/adminUploadImg.jsp?id=${admin2.id}"
								title="上传头像" class="iframeurl"><i class="icon-cog"></i>上传头像</a></li>
							<li class="divider"></li>
		...
		<div class="main-container-inner">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)"
							name="${pageContext.request.contextPath}/admin/home.html"
							class="iframeurl" title=""><i class="icon-home"></i><span
								class="menu-text"> 系统首页 </span></a></li>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-desktop"></i><span class="menu-text"> 图文管理 </span><b
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath }/picSelectAll.do"
									title="图文类表" class="iframeurl"><i
										class="icon-double-angle-right"></i>图文类表</a></li>

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath }/categoryIndex.html"
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/integration.html"
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/Systems.html"
									title="系统设置" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统设置</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/System_section.html"
									title="系统栏目管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统栏目管理</a></li>

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/System_Logs.html"
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="icon-home home-icon"></i> <a
							href="${pageContext.request.contextPath}/admin/index.jsp">首页</a>
						</li>
				...
				<iframe id="iframe"
					...
					src="${pageContext.request.contextPath}/admin/home.html">
				</iframe>
