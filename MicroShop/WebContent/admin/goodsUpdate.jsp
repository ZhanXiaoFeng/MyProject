...
<body>
		<div class="page_right_style">
			...
			<form action="${pageContext.request.contextPath }/goodsUpdateCondition.do"
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10">
						<input type="text" class="input-text" value="${goods.name}" placeholder=""
							name="name">
					</div>
				</div>
				...
				<div class=" clearfix cl">
					...
					<div class="formControls col-10">
						<input type="text" class="input-text" value="${goods.tags}" placeholder=""
							id="" name="tags">
					</div>
				</div>
					...
					<div class=" clearfix cl">
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.categoryId}" placeholder=""
									id="" name="categoryId">
							</div>
						</div>
						...
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.color}"
						...
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.price1}" placeholder=""
									id="" name="price1">
							</div>
						</div>
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.price2}" placeholder=""
									id="" name="price2">
							</div>
						</div>
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.xiaoLiang}" placeholder=""
									id="" name="xiaoLiang">
							</div>
						</div>
						...
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.source}" placeholder=""
									id="" name="source">
							</div>
						</div>
						...
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.kuCun}" placeholder=""
									id="" name="kuCun">
							</div>
						</div>
						...
						<div class="Add_p_s">
							...
							<div class="formControls col-2">
								<input type="text" class="input-text" value="${goods.level_}" placeholder=""
									id="" name="level_">
							</div>
						</div>
					</div>
