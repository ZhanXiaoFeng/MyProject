...
<link href="${pageContext.request.contextPath}/admin/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
<body>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <img
						src="${pageContext.request.contextPath}/admin/images/logo.png" width="350px">
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em
								id="time"></em></span><span class="user-info"><small>${message}</small>${admin2.username}</span>
							<i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li><a href="javascript:void(0)" name="${pageContext.request.contextPath}/selectById.do?id=${admin2.id}"
								title="个人信息" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
						    <li><a href="javascript:void(0" name="${pageContext.request.contextPath}/admin/adminUploadImg.jsp?id=${admin2.id}" title="上传头像" class="iframeurl"><i class="icon-cog"></i>上传头像</a></li>
							<li class="divider"></li>
		...
		<div class="main-container-inner">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)"
							name="${pageContext.request.contextPath}/admin/home.html" class="iframeurl" title=""><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath }/goodsSelectAll.do" title="商品类表" class="iframeurl"><i
										class="icon-double-angle-right"></i>产品类表</a></li>
								
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath }/categoryIndex.html" title="分类管理" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath }/customer/selectAllCust.do" title="会员列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>会员列表</a></li>
								<li style="display: none;" class="home"><a href="javascript:void(0)"
									name="member-Grading.html" title="等级管理" class="iframeurl"><i
										class="icon-double-angle-right" ></i>等级管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/integration.html" title="会员记录管理" class="iframeurl"><i
						...
						<li style="display: none;"><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								...
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/article_Sort.html" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/Systems.html" title="系统设置" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统设置</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/System_section.html" title="系统栏目管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统栏目管理</a></li>

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/System_Logs.html" title="系统日志" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								...
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/selectById.do?id=${admin2.id}" title="个人信息" class="iframeurl"><i
										class="icon-double-angle-right"></i>个人信息</a></li>
							    <li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/admin/adminUploadImg.jsp?id=${admin2.id}" title="上传头像" class="iframeurl"><i
										class="icon-double-angle-right"></i>上传头像</a></li>
							</ul></li>
					</ul>
				</div>
				<script type="text/javascript">
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="icon-home home-icon"></i> <a href="${pageContext.request.contextPath}/admin/index.jsp">首页</a>
						</li>
				...
				<iframe id="iframe"
					...
					name="iframe" frameborder="0" src="${pageContext.request.contextPath}/admin/home.html"> </iframe>
	...
	<div class="footer_style" id="footerstyle">
		...
		<p class="l_f">版权所有 盗版必究</p>
		<p class="r_f">地址：广西桂林市雁山区雁中路一号 邮编：540000 技术支持：XXXX</p>
	</div>
	<!--修改密码样式-->
