	...
	<div class=" page-content clearfix">
		<div id="products_style">
			...
			<div class="border clearfix">
				<span class="l_f"> <a
					href="${pageContext.request.contextPath }/admin/goodsInsert.jsp"
					title="添加商品" class="btn btn-warning Order_form"><i
						class="icon-plus"></i>添加商品</a>
				</span> <span class="r_f">商品展示<b></b>
				</span>
			</div>
			<!--产品列表展示-->
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<th width="150px">商品图像</th>
								<th width="100px">市场价格</th>
								<th width="100px">平台价格</th>
								<th width="100px">是否包邮</th>
							...
							<c:forEach items="${goods}" var="goods" varStatus="status">
								<tr>
									...
									<td width="100px"><u style="cursor: pointer"
										class="text-primary" onclick=""></u>${goods.name}</td>
									<td width="150px"><input type="image" src="${pageContext.request.contextPath}/static/upload/${goods.imgs}" style="width: 100px;height: 100px;"/></td>
									<td width="100px">${goods.price1}</td>
									<td width="100px">${goods.price2}</td>
									<td width="100px">${goods.baoYou}</td>
									<td width="80px">${goods.display}</td>
									...
									<td class="td-manage"><a
										...
										onclick="member_edit('编辑','${pageContext.request.contextPath }/goodsEditById.do?id=${goods.id}','4','','510')"
										href="javascript:;" class="btn btn-xs btn-info"><i
											class="icon-edit bigger-120"></i></a> <a title="删除"
										href="${pageContext.request.contextPath }/goodsDelete.do?id=${goods.id}" onclick="javascript:if(confirm('确定要删除此信息吗？')){alert('删除成功！');return true;}return false;"
