...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/public/css/base.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/css/login.css">
<script
	src="${pageContext.request.contextPath}/static/public/js/jquery-3.1.1.min.js"></script>
...
<body>
	...
	<div class="w">
		...
		<!-- 左边登录logo结束 -->
		<a href="#" class="q_link fr"> <b class="fl"></b> 登录页面，调查问卷
		</a>
	</div>
	<!-- ************头部页面结束********** -->
	<div id="content">
		...
		<div class="login-wrap">
				...
				<div class="login-form">
					...
					<div class="login-box" style="visibility: visible; display: block">
						...
						<div class="mc">
							<div class="form">
								<form
									action="${pageContext.request.contextPath}/customer/customerLogin.do"
									id="formlogin" method="post" onSubmit="return false;">
									<span>${message}</span> <input type="hidden" name=""
										class="hide" id="" value=""> <input type="hidden"
										name="" class="hide" id="" value=""> <input
										type="hidden" name="" class="hide" id="" value=""> <input
										type="hidden" name="" class="hide" id="" value=""> <input
										type="hidden" name="" class="hide" id="" value=""> <input
										type="hidden" name="" class="hide" id="" value=""> <input
										type="hidden" name="" class="hide" id="" value="">
									<!-- 用户名输入框fore1 -->
									<div class="item item-fore1 item-error">
										<label for="loginname" class="login-label name-label"></label>
										<input type="text" name="username" id="loginname" class="itxt"
									...
									<div id="entry" class="item item-fore2"
										...
										<input type="password" name="password" id="nloginpwd"
											class="itxt itxt-error" tabindex="2"
											autocomplete="off" placeholder="密码" > <span
											class="clear-btn" style="display: inline;"></span> <span
											class="capslock" style="display: none;"> <b></b>
											大小写锁定已打开
										</span>
									</div>
									<!-- 图片验证码开始 fore3-->
									...
									<div class="item item-fore4">
										<div class="safe">
											<span> <input type="checkbox" name="chkRememberMe"
												id="autologin" tabindex="3"> <label for>自动登录</label>
									...
									<div class="item item-fore5">
										<div class="login-btn">
											<a href="javascript:;" class="btn-img btn-entry"
												id="loginsubmit" tabindex="6" onClick="validate()">登&nbsp;&nbsp;&nbsp;&nbsp;录</a>
										</div>
									</div>
								</form>
							</div>
					...
					<div class="coagent" id="kbCoagent">
						<ul>
							<li><a href="javascript:void(0)" onClick="return false;"
								class="pdl"> <b class="QQ-icon"></b> <span>QQ</span>
							</a> <span class="line">|</span></li>
							<li><a href="javascript:void(0)" onClick="return false;"
								class="pdl"> <b class="weixin-icon"></b> <span>微信</span>
							</a> <span class="line">|</span></li>
							<li><a href="javascript:void(0)" onClick="return false;">
									微购钱包 </a> <span class="line">|</span></li>
							<li class="extra-r">
								<div class="regist-link">
									<a href="${pageContext.request.contextPath}/customer/regist.html"  class="">
										<b></b>立即注册
									</a>
								</div>
							</li>
			...
			<div class="login-banner" style="background-color: #fc3343">
				<div class="w">
					<div id="banner-bg" class="i-inner" width="700" heigth="400"
						style="background: url(${pageContext.request.contextPath}/static/picture/nav/a1.png);background-repeat:no-repeat;margin-top:40px;margin-left:-40px"></div>
				</div>
			</div>
			<!-- 中间背景广告结束 -->
		</div>
		...
		<div id="footer-2013">
			<div class="links">
				<a href="">关于我们</a> | <a href="">联系我们</a> | <a href="">人才招聘</a> | <a
					href="">商家入驻</a> | <a href="">广告服务</a> | <a href="">手机在线</a> | <a
					href="">友情链接</a> | <a href="">销售联盟</a> | <a href="">微购社区</a> | <a
					href="">微购公益</a> | <a href="">English site</a>
			</div>
		</div>
	</div>
	<!-- 底部页面结束 -->
