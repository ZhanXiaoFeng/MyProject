...
<link href="${pageContext.request.contextPath }/static/css/index.css" type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/static/css/add.css" type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/admin/css/style.css"
	type="${pageContext.request.contextPath }/text/css" rel="stylesheet">
...
<body>
		...
		<div class="jdm-toolbar J-toolbar">
			...
			<div class="jdm-toolbar-tabs J-tab">
				...
				<div class="J-trigger jdm-toolbar-tab jdm-tbar-tab-message"
					data-name="message">
					<a target="_blank" href="#"> <i class="tab-ico"></i>
	...
	<div class="header-box">
		...
		<ul class="header-right">
			<li class="denglu"><span>
               <c:choose>
   		          <c:when test="${username}==null">未登录
   		          </c:when>
   		          <c:otherwise>欢迎你：${username}
   		</c:otherwise>
			...
			<li class="denglu"><a
				...
				<a href="${pageContext.request.contextPath}/customer/regist.html" class="red">免费注册</a></li>
			<li class="shu"></li>
			<li class="denglu"><a href="${pageContext.request.contextPath}/showOrder.do">我的订单</a></li>
			<li class="shu"></li>
			<li class="my bj"><a href="#">我的微购</a> <i
			...
			<li class="shu"></li>
			<li class="daohang"><a href="#">网站导航</a> <i
				class="ci-right "> <s class="jt">◇</s>
			</i>
				<div class="aa">
					<div class="neirong">
	...
	<div class="w">
		<div class="logo">
			<a href=""><img src="./static/images/cLogo.png"></a>
		</div>
		<form
	...
	<div class="focus">
		...
		<form action="${pageContext.request.contextPath }/goodsSelectUser.do"
			method="post">
				<input type="text" name="name" value="${name}" style="display: none" />

			<div class="search1">全部结果>${name }<br><br>筛选></div>
			<div class="tags1">
				关键字 <input type="text" name="tags" value="${tags}" id="tags" /> 颜色
				<input type="text" name="color" value="${color}" id="color" /> 产地 <input
					type="text" name="source" value="${source}" id="source" /> 包邮
				&nbsp;&nbsp;yes<input type="radio" name="baoYou" value=1
					checked="checked" id="baoYou"> no<input type="radio"
					name="baoYou" value=0 id="baoYou">
			</div>
			<div class="tags1">
				最低价 <input type="text" name="price2low" value="${price2low }"
					placeholder="0.00" id="price2low" /> to
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- <div class="tags1"> -->
				最高价 <input type="text" name="price2high" value="${price2high}"
					placeholder="9999.9999" id="price2high" /> <input type="submit"
					value="完成" class="submit" />
			</div>
		</form>
					...
					<c:forEach items="${goods3}" var="good" varStatus="status">
						<div class="goods">
							<li class="fore1">
								<div class="gimg">
									<a
										href="shopdetial.jsp?goodsId=${good.id}&name=${good.name}&price2=${good.price2.toString()}&xiaoliang=${good.xiaoLiang.toString()}
							&kucun=${good.kuCun.toString()}&baoyou=${good.baoYou.toString()}&source=${good.source}&intro=${good.intro}&imgs=${good.imgs}"
										target="_blank"> <img data-lazy-img="done" width="130"
										height="130" title="${good.name}"
										src="${pageContext.request.contextPath }/static/upload/${good.imgs}"
										class="">
									</a>
								</div>
								<div class="p-info">
									...
									<div class="p-name">
										<a
											href="shopdetial.jsp?goodsId=${good.id}&name=${good.name}&price2=${good.price2.toString()}&xiaoliang=${good.xiaoLiang.toString()}
							&kucun=${good.kuCun.toString()}&baoyou=${good.baoYou.toString()}&source=${good.source}&intro=${good.intro}&imgs=${good.imgs}"
											target="_blank" title="${good.name }">${good.name}</a>
									</div>
	...
	<div class="footer" style="margin-top:736px">
				...
				<div id="footer-2014">
					<div class="links">
						<a rel="nofollow" target="_blank" href="#">关于我们</a>|<a href="#">联系我们</a>|<a
							...
							rel="nofollow" target="_blank" href="#">手机微购</a>|<a
							target="_blank" href="#">友情链接</a>|<a target="_blank" href="#">销售联盟</a>|<a
							href="#" target="_blank">微购社区</a>|<a href="#" target="_blank">微购公益</a>|<a
					...
					<div class="copyright">
						...
						<a href="#" target="_blank">网络文化经营许可证京网文[2014]2148-348号</a>&nbsp;&nbsp;违法和不良信息举报电话：4006561155&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2004-2016&nbsp;&nbsp;微购weigou.com&nbsp;版权所有<br>旗下网站：<a
