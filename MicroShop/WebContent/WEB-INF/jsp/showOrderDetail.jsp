...
<body>
	...
	<div class="shopping_content">
		...
		<form action="${pageContext.request.contextPath }/payOrder.do?orderId=${orders.id}&price=${orders.price}&addrId=${orders.addrId}&customerId=${orders.customerId}&paymethod=${orders.paymethod}"
			method="post">
			<table border="1" bordercolor="#cccccc" cellspacing="0"
				...
				<tr>
					<td height="180px" width="200px"><a><img
							src="${pageContext.request.contextPath }/static/upload/${orderItem.goods.imgs}"
							style="width: 150px; height: 150px;" /></a></td>
					<td width="150px"><span
						style="font-family: '楷体'; color: #000; font-size: 20px;">${orderItem.goods.name}</span></td>
					<td width="150px"><span
						style="font-family: '楷体'; color: #CB3437; font-size: 20px;">￥：${orderItem.goods.price2}元</span></td>
					<td width="150px"><span
						style="font-family: '楷体'; color: #000; font-size: 20px;">${orderItem.amount}</span></td>
					<td width="150px"><span
						style="font-family: '楷体'; color: #000; font-size: 20px;">${orderItem.goods.baoYou}</span></td>
					<td>
						<div>
							<span style="font-family: '楷体'; color: #000; font-size: 20px;">简介：${orderItem.goods.intro}</span><br />
						</div>
					</td>
					<td width="180px">
			...
			<div class=""
				...
				<div class="div_outMumey" style="float: left;">
					...
					<input type="submit" class="submit" value="全部付款" style="font-size: 18px;background: #f00;color:#fff;width: 120px;height: 30px;border: 0px;"/>
			</div>
				</form>
		</div>
	</div>
	...
	<div class="shade_content">
		<div class="col-xs-12 shade_colse">
			<button onclick="javascript:onclick_close();"></button>
		</div>
