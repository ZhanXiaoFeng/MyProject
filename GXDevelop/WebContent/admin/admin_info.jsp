		...
		<div class="admin_info_style">
			<div class="admin_modify_style" id="Personal">
				...
				<div class="xinxi">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="用户名" id="website-title"
								value="${res.username }" class="col-xs-7 text_info"
								disabled="disabled"> &nbsp;&nbsp;&nbsp;<a
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"
							for="form-field-1">图像： </label>
						<div class="col-sm-9">
							<input type="image" src="${pageContext.request.contextPath}/static/img/admin/${res.imgUrl}" name="图片" id="website-title"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="移动电话" id="website-title"
								value="${res.phone}" class="col-xs-7 text_info"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="电子邮箱" id="website-title"
								value="${res.email}" class="col-xs-7 text_info"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="真实姓名" id="website-title"
								value="${res.realName }" class="col-xs-7 text_info"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
