...
<script type="text/javascript" charset="UTF-8">
	$(function(){
		$("#sjs").change(function(){
			...
			location.href="menuServlet?op=findAllMenuToAdd&haveSelectedDeskId="+v ;
		});
	});
</script>
</head>
		...
		<div class="aa">
             ...
             <div class="choseLanguage">
					<div class="se">
			              ...
			              <option  class="optionLangeuage" style="font-size: 40px;"value="${haveSelectedDesk.id }" >${haveSelectedDesk.id }号餐桌</option>
		                  </c:forEach>
	                     </select>
	               </div>
	         </div>
