...
/**
* @Title: SkyDriveUtil.java
* @Package com.zrf.ex.skydrive.util
...
import com.zrf.ex.skydrive.dao.HdfsDao;

/**
 * @ClassName: SkyDriveUtil
...
public class SkyDriveUtil {
	...
	public SkyDriveUtil(Configuration conf) {
		this(HDFS, conf);
	}

	public SkyDriveUtil(String hdfs, Configuration conf) {
		this.hdfsPath = hdfs;
		this.conf = conf;
	}
