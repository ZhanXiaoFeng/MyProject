...
public class AgentSalesDetail implements java.io.Serializable {
	...
	/** minimal constructor */
	public AgentSalesDetail(Date orderDate, Integer orderType, String belongOrgName, String agentName, String entName,
			Integer businessSum, Integer contractSum, Integer dividePercent, Integer divideSum, Integer payforSum,
			Integer isReceive) {
	...
	/** full constructor */
	public AgentSalesDetail(String orderNo, Date orderDate, Integer orderType, String belongOrgId, String belongOrgName,
			String agentId, String agentName, String entId, String entName, Integer businessSum, Integer contractSum,
			Integer dividePercent, Integer divideSum, Integer payforSum, Date payforDate, Integer isReceive,
			Integer receiveSum, Date receiveDate, String remark, Date createDate) {
	...
	public String toString() {
		return "AgentSalesDetail [agentId=" + agentId + ", agentName=" + agentName + ", belongOrgId=" + belongOrgId
				+ ", belongOrgName=" + belongOrgName + ", businessSum=" + businessSum + ", contractSum=" + contractSum
				+ ", createDate=" + createDate + ", dividePercent=" + dividePercent + ", divideSum=" + divideSum
				+ ", entId=" + entId + ", entName=" + entName + ", id=" + id + ", isReceive=" + isReceive
				+ ", orderDate=" + orderDate + ", orderNo=" + orderNo + ", orderType=" + orderType + ", payforDate="
				+ payforDate + ", payforSum=" + payforSum + ", receiveDate=" + receiveDate + ", receiveSum="
				+ receiveSum + ", remark=" + remark + "]";
	}
